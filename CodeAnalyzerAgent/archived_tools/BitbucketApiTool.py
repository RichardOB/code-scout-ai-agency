...
class BitbucketApiTool(BaseTool):
    """
    This tool interfaces with the Bitbucket API to retrieve pull requests.
    It can authenticate with Bitbucket, list pull requests for a given repository,
    and fetch details of a specific pull request including the code changes.
    """
...
if __name__ == "__main__":
    tool = BitbucketApiTool(repository_slug='chatbot-service', pull_request_id=609)
